...
emoji_data = pd.read_csv('data/emojiColorDuplicates.csv')
...
def upload_file():
    ...
    return render_template('emojiArt.html', form=form, emoji_html=emoji_html, processing_time=processing_time, error_message=error_message)
